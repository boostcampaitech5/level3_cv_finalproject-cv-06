...
Description: 
'''
from .base_options_infer import BaseOptions
...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default='/opt/ml/input/code/SimSwap/arcface_model/arcface_checkpoint.tar', help="run ONNX model via TRT")
        ...
        self.parser.add_argument("--output_path", type=str, default='/opt/ml/', help="results path")
        self.parser.add_argument('--id_thres', type=float, default=0.03, help='how many test images to run')
        self.parser.add_argument('--no_simswaplogo', type=bool, default=True, help='Remove the watermark')
        self.parser.add_argument('--use_mask', type=bool, default=True, help='Use mask for better result')
